...
public class PowerUp : MonoBehaviour
{
	...
	public Transform PowerUpInstanciado; //Cria uma variável do tipo Transform, da biblioteca da Unity.
	...
	void Start()
	{
		...
		PowerUpInstanciado.transform.Translate(100f, 0.5f, positions[Random.Range(0, 3)]);//Ranom.Range vai escolher slot do array pra fazer tipo um "random" na posição z entre os valores 2, 0 e -2
	}
	...
	private void OnTriggerEnter(Collider other)
	{
		if (other.gameObject.CompareTag("Player"))
		{
            ...
            /*PowerUpInstanciado.position = new Vector3(100f, 0.5f, positions[Random.Range(0, 3)]);*/ //Faz o coletável teleportar pro inicio novamente ao tocar no  player
